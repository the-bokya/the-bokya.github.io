...
import glider from "../../../assets/img/Animated_glider_emblem.gif" 
...
<Image src={glider} alt="The Gliders are helluva minions who can come together and make awesome things" style="width:40%"/>
